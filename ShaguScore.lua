...
ShaguScore:SetScript("OnEvent", function()
  ...
  if score and r and g and b then
    GameTooltip:AddLine("ShaguPuntuación: " .. score, r,g,b)
    GameTooltip:Show()
  end
end)
...
function InspectUnit(unit)
  ...
  if score and r and g and b then
    ShaguScore.Inspect.text:SetText("ShaguPuntuación: " .. score)
...
ShaguScore.CharacterFrame:SetScript("OnEvent", function()
  ...
  if score and r and g and b then
    ShaguScore.CharacterFrame.text:SetText("ShaguPuntuación: " .. score)
